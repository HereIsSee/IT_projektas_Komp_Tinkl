<div class="col-sm-3 sidenav hidden-xs">
    ...
    <ul class="nav nav-pills nav-stacked">
        <li class="<?= ($activePage === 'dashboard') ? 'active' : '' ?>"><a href="#section1">Dashboard</a></li>
        <li class="<?= ($activePage === 'calendar') ? 'active' : '' ?>"><a href="calendar_page.php">Renginių kalendorius</a></li>
