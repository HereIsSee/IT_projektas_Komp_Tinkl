...
<head>
    ...
    <link href="../../IT_darbas/assets/css/sidenavigation.css" rel="stylesheet">
    <link href="../assets/css/all_events.css" rel="stylesheet">
    <link href="../assets/css/toggle_filter.css" rel="stylesheet">
                    ...
                    <form action="all_events.php" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="microcity_id" name="microcity_id">
                                <option value="default">--Pasirinkite mikrorajoną--</option>
                            </select>
                        </div>
                        <div class="form-group">
